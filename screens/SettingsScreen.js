  ...
  render() {
    const sections =
      this.state.tasks == undefined
        ...
        ? [{ data: this.state.tasks, title: "Tareas Completadas" }]
        : [
            {
              data: [{ title: "No hay tareas completadas" }],
      ...
      <SectionContent>
        ...
        >
          <View style={styles.taskListTextTime}>
            {item.title != "No hay tareas completadas" &&
            item.title != "Cargando..." ? (
          ...
          <Text style={styles.sectionContentText}>
            {item.title != "No hay tareas completadas" ? item.description : ""}
          </Text>
          <Text style={styles.taskListTextTimeComplete}>
            {item.title != "No hay tareas completadas" && item.title != "Cargando..."
